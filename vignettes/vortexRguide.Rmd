...
download the latest version from [www.r-project.org](www.r-project.org) for your 
operating system. 
While there is no strict requirement to do so, we find the free RStudio IDE 
([www.rstudio.com](https://www.rstudio.com/)) very handy. 
...
If you are on Windows, you have to install [Rtools](https://cran.r-project.org/bin/windows/Rtools/) (unless you have done so already), before you can use `devtools`. Download the .exe file and run it before you use `library(devtools)`. 
...
These sections are quite detailed (and possibly boring) but they are also (we believe) important if you want to have a better understanding of function operations and caveats. 
If you have already read the supplementary material of our paper presenting vortexR and you are reading this user guide because you want to clarify some aspects of these functions, then you can jump directly there.
...
Constructive feedback can be sent to  [carlopacioni@gmail.com]().
