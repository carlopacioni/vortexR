...
```
but this requires some setting up (e.g. installing Pandoc and MikText in Windows).
...
Collaterally, there are a number of functions to conduct calculations (e.g. calculation of effective population size) or further data handling that are described in more detail below. 
...
NeNRatio <- data.table(Scenario = NeStacked[ , Scenario], 
         ...
         NeNRatio = NeStacked[, Ne]/NadultsAll[, Nad])
```
...
Campbell, S., Roberts, E.J., Craemer, R., Pacioni, C., Rollins, L., and Woolnough, A.P. (2015) Assessing the economic benefits of starling detection and control to Western Australia. Australasian Journal of Environmental Management. in press. 
...
Pacioni, C., Spencer, P.B.S., Lacy, R.C., and Wayne, A.F. (in review) Predators and genetic fitness: key threatening factors for the conservation of bettong species. Pacific Concervation Biology. 
